                            ...
                            <table class="table table-hover table-bordered">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Mô tả</th>
                                        @if ($admin->hasPermission(['xoa-vai-tro', 'chinh-sua-vai-tro', 'toan-quyen-quan-ly']))
                                        ...
                                        @foreach($roles as $role)
                                            <tr>
                                                ...
                                                <td class="text-center" style="vertical-align: middle;">
                                                    @if ($admin->hasPermission(['chinh-sua-vai-tro', 'toan-quyen-quan-ly']))
                                                    <a class="btn btn-primary btn-sm" href="{{ route('role.update', $role->id) }}">
                                                        <i class="fas fa-pencil-alt"></i>
                                                    </a>
                                                    @endif
                                                    @if ($admin->hasPermission(['xoa-vai-tro', 'toan-quyen-quan-ly']))

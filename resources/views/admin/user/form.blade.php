            ...
            <div class="col-md-3">
                ...
                <div class="card card-primary card-outline">
                    <div class="card-body box-profile">
                        ...
                        @if (isset($user->ten_hien_tai))
                            <h3 class="profile-username text-center">{{ $user->ten_hien_tai }}</h3>
                        @endif
                        @if (isset($user->email))
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="settings">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="inputName" placeholder="Họ và tên" name="name" value="{{old('name', isset($user->ten_hien_tai) ? $user->ten_hien_tai : '')}}">
